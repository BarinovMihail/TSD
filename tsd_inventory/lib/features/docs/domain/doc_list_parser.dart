...
/// Пример: {"1": {"НомерДок":"АЕ-00000002","Подразделение":"Отдел закупок","ФизическоеЛицо":"Иванов Иван Иванович","Дата":"29.06.2026 10:54:23","Проведен":true}}
  ...
  for (final entry in json.entries) {
    ...
    try {
      ...
      result.add(DocListItem(
        ...
        person: _trimOrNull(v['ФизическоеЛицо']),
